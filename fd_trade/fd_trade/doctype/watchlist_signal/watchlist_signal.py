...
def create_signal(watchlist_name, ticker, current_price, trend_status,
                   ...
                   resistance_level_3=None, history=None):
    ...
    try:
        ...
        # BUG #10 FIX (19 Sep 2026): pakai history yang sudah di-fetch
        # caller (dari get_support_resistance) kalau tersedia, supaya tidak
