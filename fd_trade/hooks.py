...
app_license = "MIT"
# BUG FIX (19 Sep 2026): ihsg_banner.js didaftarkan sebagai app_include_js
# (global) supaya window.fd_trade_show_ihsg_banner() tersedia sebelum
# doctype_list_js (watchlist_list.js, watchlist_signal_list.js) jalan.
app_include_js = [
